#!/bin/bash
# A run of e076 (#92): `run.sh <world> <steps> <life> <name> [key=value ...]` puts stage C's default
...
#
# From the repo root:
#   (nohup bash experiments/e076_pair/run.sh c1225 100000 9 donor genomes=1 \
#     > experiments/e076_pair/results/donor/c1225_life9_donor.log 2>&1 < /dev/null &)
set -e
...
out=${EVLOG_OUT:-experiments/e076_pair/results}
mkdir -p $out
