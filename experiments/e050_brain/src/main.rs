...
fn main() {
    ...
    for step in 1..=steps {
        ...
        if step % LOG_INTERVAL == 0 || agents.is_empty() {
            ...
            writeln!(log, ",{:.3},{:.4},{based:.3},{:.3},{:.2},{eyed:.3},{:.3},{:.3},{wch:.4},{:.3},{:.3}",
