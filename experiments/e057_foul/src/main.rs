...
fn main() {
    ...
    writeln!(agents_csv, "step,mass,born_mass,hard,muscle,sensor,digestive,bite,shell,open,speed,age,energy,plant,meat,lineage,place,born_place,bite_any,shell_front,shell_back,shell_side,foot,len_fwd,len_side,height,fat,size,density,digest,side,water,worn,travel,drift,hidden,eta,beta,wchange,turns,pace").unwrap();
    ...
    for _ in 0..init_pop {
        ...
        let mut a = Agent {
            id: next_id - 1, lineage: 0, x: 0, y: 0, energy: INIT_ENERGY as f64, age: 0, plant: 0.0, meat: 0.0, fat: 0.0, water: 1.0, born_size: body.size, born_mass: body.mass, turns: 0, phase: 0.0, breed_now: false, born_place: NO_PLACE, born_at: (0, 0), short: false, worn: 0, worn_out: false,
    ...
    for step in 1..=steps {
        ...
        for i in 0..agents.len() {
            ...
            if agents[i].energy >= thr as f64 && (breed_law == 0 || agents[i].breed_now) {
                ...
                pending.push((Agent {
                    id: next_id - 1, lineage: a.lineage, x: a.x, y: a.y, energy: a.energy, age: 0, plant: 0.0, meat: 0.0, fat: yolk_fat, water: a.water, born_size: 0, born_mass: 0.0, turns: 0, phase: 0.0, breed_now: false, born_place: NO_PLACE, born_at: (0, 0), short: false, worn: 0, worn_out: false, alive: true,
...
mod tests {
    ...
    fn agent_with(cells: [u8; CELLS], x: usize, y: usize, facing: usize) -> Agent {
        let mut a = Agent {
            id: 0, lineage: 0, x, y, energy: 1.0, age: 0, plant: 0.0, meat: 0.0, fat: 0.0, water: 1.0, born_size: 0, born_mass: 0.0, turns: 0, phase: 0.0, breed_now: false, born_place: NO_PLACE, born_at: (0, 0), short: false, worn: 0, worn_out: false, alive: true,
