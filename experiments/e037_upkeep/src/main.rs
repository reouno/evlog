...
//! `dig`, `rootat` (e036) and `k` (the exponent of the upkeep on size, 1 by default).
...
fn main() {
    ...
    let prefix = format!("experiments/e037_upkeep/results/{size}_sigma{sigma_name}{cell_tag}{matter_tag}_r{relief}_f{flow_rate}_{}{breath_tag}{shade_tag}{spill_tag}{mut_tag}{eyes_tag}{flesh_tag}{weight_tag}{weather_tag}{digest_tag}{side_tag}{store_tag}{yolk_tag}{breed_tag}{winter_tag}{water_tag}{root_tag}{k_tag}_seed{seed}", rain.name());
