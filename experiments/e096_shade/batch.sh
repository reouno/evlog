...
#   (nohup bash experiments/e096_shade/batch.sh > experiments/e096_shade/results/batch.log 2>&1 < /dev/null &)
set -e
out=experiments/e096_shade/results/batch
mkdir -p $out
for life in 9 10 11 12 13 14; do
  EVLOG_OUT=$out nohup bash experiments/e096_shade/run.sh c1225 100000 $life g0.016 \
