...
impl Laws {
    pub fn new(rng: &mut Rng, seed: u64) -> Self {
        ...
        let morph_level = (0..=SIDE_MAX)
            ...
            .collect();
        Laws { morphogen, table, density, side, water, breath, breed, share, store, history: false, store_gene: false, morph_level }
    }
}
...
impl Occ {
    ...
    /// e097 (#109): whether any body stands over world cell c, in any layer.
    pub fn held(&self, c: usize) -> bool {
        (0..LAYERS).any(|l| self.crowd[LAYERS * c + l] > 0)
    }
