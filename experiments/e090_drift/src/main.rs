...
impl Sim {
    ...
    const AGENT_HEADER: &'static str = "step,id,lineage,age,turns,mass,size,side,density,born_size,born_mass,born_hard,born_muscle,born_sensor,born_digestive,born_bite,\
        hard,muscle,sensor,digestive,bite,bite_any,shell,speed,energy,fat,plant,meat,killed,scavenged,travel,path,worn,pace,place,born_place,temp,moist,height,medium,algae,detritus,water,drank,open_soft,breath,inhaled,breed,share,store,kids,btemp,warmed,cooled,wood,load,invader,cell,crown,seed,fermented,dunged,fiber,cells";
    ...
    fn agent_rows(&self, out: &mut dyn Write) {
        ...
        for a in &self.agents {
            ...
            writeln!(
                out,
                "{},{},{},{},{},{:.2},{},{},{:.3},{},{:.2},{},{},{},{},{},{},{},{},{},{},{},{:.2},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.3},{:.2},{:.2},{},{:.3},{},{},{:.1},{:.3},{:.0},{},{:.3},{:.3},{:.3},{},{},{:.3},{},{:.4},{:.4},{:.3},{},{:.2},{:.4},{:.4},{:.3},{:.2},{},{},{:.3},{:.3},{:.3},{:.3},{:.4},{}",
                self.step,
                a.id,
                a.lineage,
                a.age,
    ...
    fn layers(&self) -> Vec<Vec<f64>> {
        ...
        vec![water, plant, pl.soil.clone(), temp, moisture, w.rain_now.clone(), w.light.clone(), hab, pl.grass.clone(), pl.wood.clone(), pl.algae.clone(), pl.litter.clone(), fire, pl.carrion.clone(), dryness, pl.browse.clone(), pl.seed.clone()]
    }
}
