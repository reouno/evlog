...
pub struct World {
    ...
    pub wind_to: (f64, f64), // e090: cells (x, y) one cell downwind, the wind of the last update (#100 D)
    // scratch
...
impl World {
    ...
    pub fn update(&mut self, p: &Params, sat: &Sat, step: f64, soil: &mut [f64], wood: &[f64]) -> Flux {
        ...
        self.wind_to = (ang.cos(), ang.sin()); // e090 (#100 D): one cell downwind, for the seed
