...
impl Sim {
    ...
    fn bodies(&mut self) {
        let Sim { p, w, agents, pl, occ, g, rng, wear_rng, k, hab, wet: wet_cells, dryness, drink_at, vis, laws, cache, threads, next_id, born, dead, wsea, .. } = self;
        let g = *g;
