#!/usr/bin/env python3
"""e075 with both rates 0 is e073: compare a check run to the kept run of e073 it copies.

Run from the repo root:

    uv run python experiments/e075_hunt/check.py \
      experiments/e075_hunt/results/c1225_life9_check \
...
step, every lineage row and every event must agree. The columns e074 and e075 add (the invaders, the tear) are ignored.
"""
import csv
import sys
