...
# The same world with e014's cost law (a blocked move costs the move) and e012's world without space, seeds 1-4: label -> (run prefix, folder, widths).
REFS = {
...
<title>e015 Work is force times distance - Report</title>
<style>{CSS}</style>
</head>
<body>
<main>
<h1>e015: Work is force times distance</h1>
...
<h2>Appendix: data</h2>
<p>Every 100,000th record; full logs in <code>results/*_log.csv</code>, per place in <code>results/*_places.csv</code>, lineages in <code>results/*_lineages.csv</code>, events in <code>results/*_events.csv</code>, agents every 100,000 steps in <code>results/*_agents.csv</code>, snapshots in <code>results/*_{{long,clip,bodies}}.jsonl</code>. Reference runs are read from <code>../e014_body_space/results</code> and <code>../e012_two_places/results</code>. Build this report with <code>uv run python experiments/e015_move_work/report.py</code>.</p>
{tables}
</main>
