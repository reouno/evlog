#!/usr/bin/env python3
"""Read the control ladder at six seeds (#102, the yardstick).

Run from the repo root: `uv run python experiments/e092_yardstick/sweep.py` (a few minutes).

The six runs are the same world with no law added: e081's ladder (seeds 9, 10, 11, `u0`) and e092's
(seeds 12, 13, 14, `ctl`). For each it reads, with e075's `read_run` (e068's census by birth form),
...
E092 = os.path.join(HERE, "results", "ladder")
RUNS = [(9, os.path.join(E081, "c1225_life9_u0")),
        (10, os.path.join(E081, "c1225_life10_u0")),
        (11, os.path.join(E081, "c1225_life11_u0")),
        (12, os.path.join(E092, "c1225_life12_ctl")),
        (13, os.path.join(E092, "c1225_life13_ctl")),
        (14, os.path.join(E092, "c1225_life14_ctl"))]
CHECK = (os.path.join(E092, "c1225_life9_ctl"), os.path.join(E081, "c1225_life9_u0"))
