#!/usr/bin/env python3
"""Read e103's runs against their five hypotheses (#116, rung 2).

Run from the repo root: `uv run python experiments/e103_producers/measure.py [results_dir run ...]` (a minute).
